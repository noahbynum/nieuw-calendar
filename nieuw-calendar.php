...
// A second copy in another folder (nieuw-calendar-1, nieuw-calendar-main)
// must not load. Two copies redeclare classes and blank the calendar.
if ( defined( 'NIEUW_CALENDAR_VERSION' ) ) {
	return;
}

define( 'NIEUW_CALENDAR_VERSION', '1.2.5' );
